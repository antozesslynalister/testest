...
//                a.AddFlight(cfft_flight); // add the flight to the airline
...
//                a.AddFlight(norm_flight); // add the flight to the airline
//            }
//        }
//    }
...
//    while (true)                                                                         // data validation : if the format is wrong, retry 
//    {
//        Console.Write("Enter Flight Number: ");
//        flightNum = Console.ReadLine();
//        if (flightdict.ContainsKey(flightNum))
...
//            //you need to test whether the flight is a CFFTFlight, DDJBFlight, LWTTFlight or NORMFlight
//            //the way to do that is to test the downcast, or in this example i've given you, test whether the class is the subclass
//            //you probably don't need the Special Request Code line in your Flight.cs (I will indicate there as well)
...
//        //Your flight updated prints twice, so I would suggest deleting either this line or the ones within your smaller functions/methods
//        //Though you should probably delete this line cos the ones within your smaller methods print different things
...
//        //same as in the displayfullflightdetails method, you need to test whether the flight is a subclass
